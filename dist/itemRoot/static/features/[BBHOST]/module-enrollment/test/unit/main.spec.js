...
describe('Provider', function() {
    ...
    describe('Module Enrollment', function() {
        ...
        it('API should have [verifyEmail] method', ngInject(function() {
            expect(api.verifyEmail).toBeFunction();
        }));
    ...
    describe('Util Enrollment', function() {
        ...
        it('Phone Normalization test #1', function() {
            expect(utils.makePhoneInternationalUSA('123-123-1234')).toBe('1231231234');
        });

        it('Phone Normalization test #2', function() {
            expect(utils.makePhoneInternationalUSA('123.123.1234')).toBe('1231231234');
        });

        it('Phone Normalization test #3', function() {
            expect(utils.makePhoneInternationalUSA('1231231234')).toBe('1231231234');
        });
