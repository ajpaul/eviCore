define(function(require, exports, module) {
    ...
    exports.SavingGoalService = function($q, $timeout, SavingGoal, lpCoreUtils) {
        ...
        var transformSaving = function(savingGoal) {
            ...
            savingGoal.percentageSaved = savingGoal.amount ? Math.round(savingGoal.saved * 100 / savingGoal.amount) : 0;
            savingGoal.targetDate = lpCoreUtils.date(savingGoal.targetDate).toDate();
        ...
        return {
            ...
            update: function(savingGoal) {
                ...
                SavingGoal.update({savingId: savingGoal.id}, savingGoal, function(resp) {
                    deferred.resolve(transformSaving(savingGoal));
                });
