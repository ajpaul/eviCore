define(function(require, exports, module) {
    ...
    // @ngInject
    exports.NotificationsModel = function($rootScope, $timeout, httpService, lpCoreUtils) {
         /**
        ...
        NotificationsModel.prototype.loadNotifications = function() {
            ...
            xhr.success(function(data) {
                var notifications = data.messages || data.notifications;
                if(notifications) {
                    lpCoreUtils.forEach(notifications, function(message) {
        ...
        NotificationsModel.prototype.getAlertClass = function(notification) {
            ...
            return severityLevels[notification.level] || 'alert-info';
        };
        ...
        NotificationsModel.prototype.closeNotification = function(notification) {
            ...
            var closeOnServer = function() {
                ...
                closeNotificationService.create({contentType: 'application/json'});
            };
