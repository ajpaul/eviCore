define(function(require, exports, module) {
    ...
    // @ngInject
    exports.ExpensePlanningController = function($scope, $rootElement, $timeout, lpWidget, $log, i18nUtils, ExpensesModel, lpUIResponsive, lpCoreUtils) {
        ...
        var initialize = function() {
            var partialsDir = util.getWidgetBaseUrl(widget) + '/partials/';
        ...
        $scope.filterPayments = function(dateObj) {
            ...
            return $.isEmptyObject(activePayments) ? null : activePayments;
        };
