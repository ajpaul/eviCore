define(function(require, exports, module) {
    ...
    // @ngInject
    exports.P2PPreferencesController = function($scope, $templateCache, lpCoreUtils, $timeout, lpWidget, AccountsModel, lpP2P, i18nUtils, lpCoreBus) {
        ...
        var initialize = function () {
            ...
            $scope.p2pService.getAll().then(function(response) {
                ...
                $scope.p2pUserDetails.emails = [{value: response.email, primary: true, verified: response.emailVerified}];
            ...
            $scope.templates = {
                verify: 'templates/verify-email.html'
            };
