...
define(function(require, exports, module) {
    ...
    exports.PreferencesController = function($scope, lpWidget, $timeout, lpCoreI18n, lpCoreI18nUtils,
        lpCoreUtils, lpCoreBus, lpCoreError, dropdownSelectConfig, AccountsModel, lpUsersPreference) {
        ...
        AccountsModel.load().then(function(acnts) {
            ...
            lpUsersPreference.read().then(function(prefs) {
        ...
        $scope.save = function(key, value) {
            ...
            lpUsersPreference.put(key, value)
            .then(function(res) {
