...
define( function( require, exports, module) {
	...
	exports.MainCtrl = function(lpEbilling, lpEbillingUtils) {
		...
		this.isTouch = lpEbillingUtils.isTouch;
		this.baseUrl = eBillOptions.baseUrl;
	};
	...
	// @ngInject
	exports.PaymentCtrl = function(lpEbilling, lpEbillingUtils, $scope, $timeout) {
		...
		$timeout(function() {
			ctrl.paymentParams.amount = ctrl.bill.amount;
		});

		$scope.$watch('payCtrl.specificAmount', function(value){
