...
(function () {
    ...
    var html = {
        ...
        DESIGN_CONTROLS_HTML:
            ...
            "<button class='lp-carousel-prev' data-dir=prev><i class='bi bi-pm-arrow-left'></i></button>" +
            "<span class='lp-carousel-index'>1 / {{numSlides}}</span>" +
            "<button class='lp-carousel-next' data-dir=next><i class='bi bi-pm-arrow-right'></i></button>" +
            "</div>"
    };
